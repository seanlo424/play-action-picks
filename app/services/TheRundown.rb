class TheRundown
	...
	def self.get_games(week, season)
		response = RestClient.get(
		 'https://therundown-therundown-v1.p.rapidapi.com/sports/2/events/11-10-2019?include=scores',
		...
		json_response["events"].each do |e|
			...
			game = Game.find_or_create_by(ht_id: home_team.id, at_id: away_team.id, api_event_id: e["event_id"], week: "10", season: "2019")
		end
	end
end